...
import { addMedicationMetadata, addTag, execute, findMedicineByBarcode, query } from '../src/database/db';
...
function AddProductScreen() {
  ...
  // Load existing data or clear for new product
  useEffect(() => {
    if (!editId) {
      setName('');
      setSubst('');
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTxt}>{editId ? 'Edycja\nproduktu' : 'Dodawanie\nnowego produktu'}</Text>
